...
public class GameManager : MonoBehaviour
{
    ...
    PlayerController.PlayerWeaponsStruct[] playerWeapons;
    ...
    public void SavePlayerWeapons()
    {
        ...
        if (player != null)
        {
            playerWeapons = player.GetComponent<PlayerController>().playerWeaponStructs;
        }
    }
    ...
    public void RestorePlayerWeapons()
    {
        ...
        {
            player.GetComponent<PlayerController>().playerWeaponStructs = playerWeapons;
        }
    }
